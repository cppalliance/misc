...
This document outlines the plan to integrate a Retrieval-Augmented Generation (RAG) system into `website-v2` project to automatically generate and display AI-powered summaries of Boost mailing list discussions on the community page (`/community/`) after human review processes in Wagtail.
...
This plan provides a roadmap for integrating RAG capabilities into `website-v2` Community page. The modular design ensures maintainability, while testing ensures reliability.
...
**Handled separately via Wagtail**:
